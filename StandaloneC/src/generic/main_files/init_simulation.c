...
Loop_arguments* init_simulation(void)
{
	...
	#ifdef YARP
    RobotranYarp_interface* robotranYarp_interface = NULL;
    #endif
    ...
    robotranYarp_interface = (RobotranYarp_interface*) malloc (sizeof(RobotranYarp_interface) );
    robotranYarp_interface->yarpNetwork = NULL;
    robotranYarp_interface->controlBoardList = NULL;

    if(! yarp_init(robotranYarp_interface)  )
    {
	...
	#ifdef YARP
    loop_arguments->RobotranYarp_interface = robotranYarp_interface;
    #endif
