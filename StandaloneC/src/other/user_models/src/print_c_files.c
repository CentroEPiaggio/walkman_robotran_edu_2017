...
void print_c_user_models(MDS_gen_strct* gen, char *fileoutC, char *fileoutH)
{
	...
	if (gen->user_models->n_user_model == 0)
		fprintf(fidH, "typedef void* UserModelStruct;  // no user model in the mbs \n");
	else
	{
